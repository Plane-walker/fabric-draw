...
a = {
    'groups': {'orderer.test.com': {'peers': ['peer0.org1.test.com 1.1.1.1：7050'], 'blockchains': ['channel-1']}, 'org1.test.com': {'peers': []}},
    'peers': {
        'peer0.org1.test.com': {
...
class Node:
    def __init__(self, address, node_type, fellow_list):
    ...
    def run(self):
        if self.node_type == 'leader':
            if self.ct_result[self.ct_uid] == self.ct_uid:
                # generate orderer
                pass
            # generate peer
